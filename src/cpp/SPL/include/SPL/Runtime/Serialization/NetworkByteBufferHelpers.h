...
#ifndef SPL_RUNTIME_SERIALIZATION_NETWORK_BYTE_BUFFER_HELPERS_H
#define SPL_RUNTIME_SERIALIZATION_NETWORK_BYTE_BUFFER_HELPERS_H

/*!
 * \file NetworkByteBufferHelpers.h \brief Definitions of the << and >> operator
 * overloads for serializing %SPL types to SPL::NetworkByteBuffer class.
 */
...
inline NetworkByteBuffer & operator << (NetworkByteBuffer & sbuf, std::string const & val)
{
    sbuf.addSTLString(val); return sbuf;
}

inline NetworkByteBuffer & operator >> (NetworkByteBuffer & sbuf, std::string & val)
{
    sbuf.getSTLString(val); return sbuf;
}

template <class T>
inline NetworkByteBuffer & operator << (NetworkByteBuffer & sbuf, const std::vector<T> & vec)
{
...
template <class T>
inline NetworkByteBuffer & operator >> (NetworkByteBuffer & sbuf, std::vector<T> & vec)
{
...
inline NetworkByteBuffer & operator << (NetworkByteBuffer & sbuf, const std::pair<K, V> & pr)
{
    sbuf << pr.first;
    sbuf << pr.second;
    return sbuf;
...
template <class K, class V>
inline NetworkByteBuffer & operator >> (NetworkByteBuffer & sbuf, std::pair<K, V> & pr)
{
    sbuf >> pr.first;
    sbuf >> pr.second;
    return sbuf;
...
template <class K, class V>
inline NetworkByteBuffer & operator << (NetworkByteBuffer & sbuf, const std::tr1::unordered_map<K, V> & map)
{
...
template <class K, class V>
inline NetworkByteBuffer & operator >> (NetworkByteBuffer & sbuf, std::tr1::unordered_map<K, V> & map)
{
    uint32_t size = sbuf.getUInt32();
    map.clear();
    std::pair<K,V> pr;
...
template <class T>
inline NetworkByteBuffer & operator << (NetworkByteBuffer & sbuf, const std::tr1::unordered_set<T> & set)
{
...
template <class T>
inline NetworkByteBuffer & operator >> (NetworkByteBuffer & sbuf, std::tr1::unordered_set<T> & set)
{
    uint32_t size = sbuf.getUInt32();
    set.clear();
    T value;
...
template <class K, class V>
inline NetworkByteBuffer & operator << (NetworkByteBuffer & sbuf, const std::map<K, V> & map)
{
    sbuf.addUInt32(static_cast<uint32_t>(map.size()));
...
template <class K, class V>
inline NetworkByteBuffer & operator >> (NetworkByteBuffer & sbuf, std::map<K, V> & map)
{
    uint32_t size = sbuf.getUInt32();
    map.clear();
    std::pair<K,V> pr;
...
#endif /* SPL_RUNTIME_SERIALIZATION_NETWORK_BYTE_BUFFER_HELPERS_H */
