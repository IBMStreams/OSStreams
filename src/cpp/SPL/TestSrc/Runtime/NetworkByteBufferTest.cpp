...
class netbuftest : public DistilleryApplication
{
  public:
    virtual int run(const arg_vector_t& args)
    {
        ...
        NetworkByteBuffer bad_resize((unsigned char*)my_strings, 4);
        try {
        ...
        NetworkByteBuffer tmp2(const_cast<unsigned char*>(buf), tmp.getSerializedDataSize());
        ...
        cout << endl;
        NetworkByteBuffer tmp6(const_cast<unsigned char*>(tmp5.getPtr()),
        ...
        {
            NetworkByteBuffer largeBuffer1;
...
#if __LP64__
        {
            NetworkByteBuffer largeBuffer2;
        ...
        cout << endl << "All NetworkByteBuffer tests succeeded" << endl;
