...
#ifndef SPL_RUNTIME_WINDOW_IMPL_COUNT_DELTA_SLIDING_WINDOW_IMPL_H
#define SPL_RUNTIME_WINDOW_IMPL_COUNT_DELTA_SLIDING_WINDOW_IMPL_H
...
#include "SlidingTypedefs.h"
  ...
  protected:
    ...
    {
        // Common base, right parent
        stream << "CountDeltaSlidingWindowImpl={";
...
#endif /* SPL_RUNTIME_WINDOW_IMPL_COUNT_DELTA_SLIDING_WINDOW_IMPL_H */
