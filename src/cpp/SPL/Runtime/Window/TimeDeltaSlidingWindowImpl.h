...
#ifndef SPL_RUNTIME_WINDOW_IMPL_TIME_DELTA_SLIDING_WINDOW_IMPL_H
#define SPL_RUNTIME_WINDOW_IMPL_TIME_DELTA_SLIDING_WINDOW_IMPL_H
...
#include "SlidingTypedefs.h"
    ...
    virtual ~TimeDeltaSlidingWindowImpl() {}
  ...
  protected:
    ...
    {
        // Common base, left parent, right parent
        stream << "TimeDeltaSlidingWindowImpl={";
...
#endif /* SPL_RUNTIME_WINDOW_IMPL_TIME_DELTA_SLIDING_WINDOW_IMPL_H */
