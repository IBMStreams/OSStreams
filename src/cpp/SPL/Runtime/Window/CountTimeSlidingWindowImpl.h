...
#ifndef SPL_RUNTIME_WINDOW_IMPL_COUNT_TIME_SLIDING_WINDOW_IMPL_H
#define SPL_RUNTIME_WINDOW_IMPL_COUNT_TIME_SLIDING_WINDOW_IMPL_H
...
#include "SlidingTypedefs.h"
    ...
    virtual ~CountTimeSlidingWindowImpl() {}
    ...
    size_t hash() const
    {
        // Common base, (left parent holds no state), right parent
  ...
  protected:
    ...
    {
        // Right parent, (left parent holds no state), common base
    ...
    void print(std::ostream& stream) const
    {
        ...
        stream << "CountTimeSlidingWindowImpl={";
        SlidingWindowImpl<T, G, D, S>::print(stream);
        stream << ", ";
        CountStarSlidingWindowImpl<T, G, D, S>::print(stream);
        stream << ", ";
...
#endif /* SPL_RUNTIME_WINDOW_IMPL_COUNT_TIME_SLIDING_WINDOW_IMPL_H */
