...
#ifndef SPL_AST_VISITOR_PUSH_POP_H
#define SPL_AST_VISITOR_PUSH_POP_H
...
/// Visitor for SPL AST that pushes and pops scopes, for any AstNode
/// that has a SymbolTableEntry (installed by NameDefFinder) that holds
/// a scope. Any visitors that need to look up symbols in the "current
/// scope" should subclass this visitor to reuse the correct push/pop
/// behavior.
class AstVisitorPushPop : public AstVisitor
{
  protected:
    ParserContext& _pCtx;
    SymbolTable& _symTab;

    AstVisitorPushPop(ParserContext&, Debug::DebugFlag df);
...
#endif /* SPL_AST_VISITOR_PUSH_POP_H */
