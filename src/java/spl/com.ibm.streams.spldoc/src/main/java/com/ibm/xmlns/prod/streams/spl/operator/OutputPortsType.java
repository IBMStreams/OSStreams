 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Output Ports Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link com.ibm.xmlns.prod.streams.spl.operator.OutputPortsType#getOutputPortSet <em>Output
 *       Port Set</em>}
 *   <li>{@link com.ibm.xmlns.prod.streams.spl.operator.OutputPortsType#getOutputPortOpenSet
 *       <em>Output Port Open Set</em>}
 * </ul>
 *
 * @see com.ibm.xmlns.prod.streams.spl.operator.OperatorPackage#getOutputPortsType()
 * @model extendedMetaData="name='outputPortsType' kind='elementOnly'"
 * @generated
 */
public interface OutputPortsType extends EObject {
  /**
   * Returns the value of the '<em><b>Output Port Set</b></em>' containment reference list. The list
   * contents are of type {@link com.ibm.xmlns.prod.streams.spl.operator.OutputPortSetType}.
   * <!-- begin-user-doc -->
   *
   ...
   * @see com.ibm.xmlns.prod.streams.spl.operator.OperatorPackage#getOutputPortsType_OutputPortSet()
   * @model containment="true" extendedMetaData="kind='element' name='outputPortSet'
   *     namespace='##targetNamespace'"
   * @generated
   */
  EList<OutputPortSetType> getOutputPortSet();
   ...
   * @see #setOutputPortOpenSet(OutputPortOpenSetType)
   * @see
   *     com.ibm.xmlns.prod.streams.spl.operator.OperatorPackage#getOutputPortsType_OutputPortOpenSet()
   * @model containment="true" extendedMetaData="kind='element' name='outputPortOpenSet'
   *     namespace='##targetNamespace'"
   * @generated
   */
  OutputPortOpenSetType getOutputPortOpenSet();
   ...
   * @generated
   */
  void setOutputPortOpenSet(OutputPortOpenSetType value);
} // OutputPortsType
