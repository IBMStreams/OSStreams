 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Enum Window Punct Input Mode
 * Type</b></em>', and utility methods for working with them.
 * <!-- end-user-doc -->
 *
 * @see com.ibm.xmlns.prod.streams.spl.toolkit.ToolkitPackage#getEnumWindowPunctInputModeType()
 * @model extendedMetaData="name='enumWindowPunctInputModeType'"
 * @generated
 */
public enum EnumWindowPunctInputModeType implements Enumerator {
  /**
  ...
  /**
   * An array of all the '<em><b>Enum Window Punct Input Mode Type</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
   */
  private static final EnumWindowPunctInputModeType[] VALUES_ARRAY =
      new EnumWindowPunctInputModeType[] {
        EXPECTING, OBLIVIOUS, WINDOW_BOUND,
      };

  /**
   * A public read-only list of all the '<em><b>Enum Window Punct Input Mode Type</b></em>'
   * enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
   */
  public static final List<EnumWindowPunctInputModeType> VALUES =
      Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Enum Window Punct Input Mode Type</b></em>' literal with the specified
   * literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
   */
  public static EnumWindowPunctInputModeType get(String literal) {
    for (int i = 0; i < VALUES_ARRAY.length; ++i) {
      EnumWindowPunctInputModeType result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  public static EnumWindowPunctInputModeType getByName(String name) {
    for (int i = 0; i < VALUES_ARRAY.length; ++i) {
      EnumWindowPunctInputModeType result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  public static EnumWindowPunctInputModeType get(int value) {
    switch (value) {
   ...
   * @generated
   */
  private EnumWindowPunctInputModeType(int value, String name, String literal) {
    this.value = value;
    this.name = name;
