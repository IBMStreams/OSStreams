 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Java Op Input Port Set Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link com.ibm.xmlns.prod.streams.spl.operator.JavaOpInputPortSetType#getCardinality
 *       <em>Cardinality</em>}
 *   <li>{@link com.ibm.xmlns.prod.streams.spl.operator.JavaOpInputPortSetType#isOptional
 *       <em>Optional</em>}
 * </ul>
 *
 * @see com.ibm.xmlns.prod.streams.spl.operator.OperatorPackage#getJavaOpInputPortSetType()
 * @model extendedMetaData="name='javaOpInputPortSetType' kind='elementOnly'"
 * @generated
 */
public interface JavaOpInputPortSetType extends JavaOpInputPortOpenSetType {
  /**
   ...
   * @see
   *     com.ibm.xmlns.prod.streams.spl.operator.OperatorPackage#getJavaOpInputPortSetType_Cardinality()
   ...
   * @see
   *     com.ibm.xmlns.prod.streams.spl.operator.OperatorPackage#getJavaOpInputPortSetType_Optional()
