 ...
 *
 * <ul>
 *   <li>{@link com.ibm.xmlns.prod.streams.spl.common.LibraryType#getDescription
 *       <em>Description</em>}
 *   <li>{@link com.ibm.xmlns.prod.streams.spl.common.LibraryType#getManagedLibrary <em>Managed
 *       Library</em>}
 * </ul>
 *
 * @see com.ibm.xmlns.prod.streams.spl.common.CommonPackage#getLibraryType()
...
public interface LibraryType extends EObject {
   ...
   * @see com.ibm.xmlns.prod.streams.spl.common.CommonPackage#getLibraryType_Description()
  ...
  /**
   * Sets the value of the '{@link com.ibm.xmlns.prod.streams.spl.common.LibraryType#getDescription
   ...
   * @see #setManagedLibrary(ManagedLibraryType)
   * @see com.ibm.xmlns.prod.streams.spl.common.CommonPackage#getLibraryType_ManagedLibrary()
   * @model containment="true" required="true" extendedMetaData="kind='element'
   *     name='managedLibrary' namespace='##targetNamespace'"
   * @generated
   */
  ManagedLibraryType getManagedLibrary();
   ...
   * @generated
   */
  void setManagedLibrary(ManagedLibraryType value);
} // LibraryType
