 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Enum Expression Mode Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 *
 * @see com.ibm.xmlns.prod.streams.spl.toolkit.ToolkitPackage#getEnumExpressionModeType()
 * @model extendedMetaData="name='enumExpressionModeType'"
 * @generated
 */
public enum EnumExpressionModeType implements Enumerator {
  /**
  ...
  /**
   * An array of all the '<em><b>Enum Expression Mode Type</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
   */
  private static final EnumExpressionModeType[] VALUES_ARRAY =
      new EnumExpressionModeType[] {
        ATTRIBUTE, ATTRIBUTE_FREE, CONSTANT, CUSTOM_LITERAL, EXPRESSION, NONEXISTENT,
      };

  /**
   * A public read-only list of all the '<em><b>Enum Expression Mode Type</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
   */
  public static final List<EnumExpressionModeType> VALUES =
      Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Enum Expression Mode Type</b></em>' literal with the specified literal
   * value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
   */
  public static EnumExpressionModeType get(String literal) {
    for (int i = 0; i < VALUES_ARRAY.length; ++i) {
      EnumExpressionModeType result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Enum Expression Mode Type</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
   */
  public static EnumExpressionModeType getByName(String name) {
    for (int i = 0; i < VALUES_ARRAY.length; ++i) {
      EnumExpressionModeType result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Enum Expression Mode Type</b></em>' literal with the specified integer
   * value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
   * @generated
   */
  public static EnumExpressionModeType get(int value) {
    switch (value) {
   ...
   * @generated
   */
  private EnumExpressionModeType(int value, String name, String literal) {
    this.value = value;
    this.name = name;
