...
public class InfoSwitch<T> extends Switch<T> {
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    switch (classifierID) {
      ...
      case InfoPackage.SAB_FILES_TYPE:
        {
          SabFilesType sabFilesType = (SabFilesType) theEObject;
          T result = caseSabFilesType(sabFilesType);
          if (result == null) result = defaultCase(theEObject);
          return result;
        }
      case InfoPackage.TOOLKIT_INFO_MODEL_TYPE:
        {
          ToolkitInfoModelType toolkitInfoModelType = (ToolkitInfoModelType) theEObject;
          T result = caseToolkitInfoModelType(toolkitInfoModelType);
          if (result == null) result = defaultCase(theEObject);
          return result;
        }
      default:
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Sab Files Type</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null; returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   *
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Sab Files Type</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseSabFilesType(SabFilesType object) {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Toolkit Info Model
   * Type</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null; returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   *
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Toolkit Info Model
   *     Type</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseToolkitInfoModelType(ToolkitInfoModelType object) {
    return null;
  }
