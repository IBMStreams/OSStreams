 ...
 *
 * <ul>
 *   <li>{@link com.ibm.xmlns.prod.streams.spl.common.impl.LibraryTypeImpl#getDescription
 *       <em>Description</em>}
 *   <li>{@link com.ibm.xmlns.prod.streams.spl.common.impl.LibraryTypeImpl#getManagedLibrary
...
public class LibraryTypeImpl extends MinimalEObjectImpl.Container implements LibraryType {
  ...
  protected EClass eStaticClass() {
    return CommonPackage.Literals.LIBRARY_TYPE;
  }
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              CommonPackage.LIBRARY_TYPE__DESCRIPTION,
              oldDescription,
              newDescription);
      ...
      if (description != null)
        msgs =
            ((InternalEObject) description)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - CommonPackage.LIBRARY_TYPE__DESCRIPTION,
                    null,
                    msgs);
  ...
  public NotificationChain basicSetManagedLibrary(
      ManagedLibraryType newManagedLibrary, NotificationChain msgs) {
    ManagedLibraryType oldManagedLibrary = managedLibrary;
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification =
          new ENotificationImpl(
              this,
              Notification.SET,
              CommonPackage.LIBRARY_TYPE__MANAGED_LIBRARY,
              oldManagedLibrary,
              newManagedLibrary);
      if (msgs == null) msgs = notification;
      else msgs.add(notification);
   ...
   * @generated
   */
  public void setManagedLibrary(ManagedLibraryType newManagedLibrary) {
      ...
      if (managedLibrary != null)
        msgs =
            ((InternalEObject) managedLibrary)
                .eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - CommonPackage.LIBRARY_TYPE__MANAGED_LIBRARY,
                    null,
                    msgs);
  ...
  public NotificationChain eInverseRemove(
    ...
    switch (featureID) {
      case CommonPackage.LIBRARY_TYPE__DESCRIPTION:
        return basicSetDescription(null, msgs);
      case CommonPackage.LIBRARY_TYPE__MANAGED_LIBRARY:
  ...
  public void eSet(int featureID, Object newValue) {
    switch (featureID) {
      case CommonPackage.LIBRARY_TYPE__DESCRIPTION:
        ...
        return;
      case CommonPackage.LIBRARY_TYPE__MANAGED_LIBRARY:
        setManagedLibrary((ManagedLibraryType) newValue);
        return;
    }
  ...
  public void eUnset(int featureID) {
    switch (featureID) {
      case CommonPackage.LIBRARY_TYPE__DESCRIPTION:
        ...
        return;
      case CommonPackage.LIBRARY_TYPE__MANAGED_LIBRARY:
        setManagedLibrary((ManagedLibraryType) null);
        return;
    }
