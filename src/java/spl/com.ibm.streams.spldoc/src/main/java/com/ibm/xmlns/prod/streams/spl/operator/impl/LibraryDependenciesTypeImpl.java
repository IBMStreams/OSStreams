 ...
 *
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Library Dependencies Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>The following features are implemented:
 *
 * <ul>
 *   <li>{@link com.ibm.xmlns.prod.streams.spl.operator.impl.LibraryDependenciesTypeImpl#getLibrary
 *       <em>Library</em>}
 * </ul>
 *
 * @generated
 */
public class LibraryDependenciesTypeImpl extends MinimalEObjectImpl.Container
    implements LibraryDependenciesType {
  /**
   ...
   * @generated
   */
  protected LibraryDependenciesTypeImpl() {
    super();
  }
  ...
  protected EClass eStaticClass() {
    return OperatorPackage.Literals.LIBRARY_DEPENDENCIES_TYPE;
  }
    ...
    if (library == null) {
      library =
          new EObjectContainmentEList<LibraryType>(
              LibraryType.class, this, OperatorPackage.LIBRARY_DEPENDENCIES_TYPE__LIBRARY);
    }
    return library;
  }
  ...
  public NotificationChain eInverseRemove(
    ...
    switch (featureID) {
      case OperatorPackage.LIBRARY_DEPENDENCIES_TYPE__LIBRARY:
