 ...
 *
 * <ul>
 *   <li>{@link com.ibm.xmlns.prod.streams.spl.source.code.DocumentRoot#getMixed <em>Mixed</em>}
 *   <li>{@link com.ibm.xmlns.prod.streams.spl.source.code.DocumentRoot#getXMLNSPrefixMap <em>XMLNS
 *       Prefix Map</em>}
 *   <li>{@link com.ibm.xmlns.prod.streams.spl.source.code.DocumentRoot#getXSISchemaLocation <em>XSI
 *       Schema Location</em>}
 *   <li>{@link com.ibm.xmlns.prod.streams.spl.source.code.DocumentRoot#getSourceModel <em>Source
 *       Model</em>}
 * </ul>
 *
 * @see com.ibm.xmlns.prod.streams.spl.source.code.CodePackage#getDocumentRoot()
...
public interface DocumentRoot extends EObject {
   ...
   * @see com.ibm.xmlns.prod.streams.spl.source.code.CodePackage#getDocumentRoot_Mixed()
   ...
   * @see com.ibm.xmlns.prod.streams.spl.source.code.CodePackage#getDocumentRoot_XMLNSPrefixMap()
   ...
   * @see com.ibm.xmlns.prod.streams.spl.source.code.CodePackage#getDocumentRoot_XSISchemaLocation()
   * @model mapType="org.eclipse.emf.ecore.EStringToStringMapEntry<org.eclipse.emf.ecore.EString,
   *     org.eclipse.emf.ecore.EString>" transient="true" extendedMetaData="kind='attribute'
   ...
   * <!-- begin-user-doc -->
   *
   * <p>If the meaning of the '<em>Source Model</em>' containment reference isn't clear, there
   * really should be more of a description here...
   * <!-- end-user-doc -->
   *
   * @return the value of the '<em>Source Model</em>' containment reference.
   * @see #setSourceModel(SourceModelType)
   * @see com.ibm.xmlns.prod.streams.spl.source.code.CodePackage#getDocumentRoot_SourceModel()
   * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
   *     extendedMetaData="kind='element' name='sourceModel' namespace='##targetNamespace'"
   * @generated
   */
  SourceModelType getSourceModel();
   ...
   * @generated
   */
  void setSourceModel(SourceModelType value);
} // DocumentRoot
