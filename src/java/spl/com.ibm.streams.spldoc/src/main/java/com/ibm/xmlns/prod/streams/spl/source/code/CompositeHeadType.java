 ...
 *
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Composite Head Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>The following features are supported:
 *
 * <ul>
 *   <li>{@link com.ibm.xmlns.prod.streams.spl.source.code.CompositeHeadType#getSplDoc <em>Spl
 *       Doc</em>}
 *   <li>{@link com.ibm.xmlns.prod.streams.spl.source.code.CompositeHeadType#getModifiers
 *       <em>Modifiers</em>}
 *   <li>{@link com.ibm.xmlns.prod.streams.spl.source.code.CompositeHeadType#getInputs
 *       <em>Inputs</em>}
 *   <li>{@link com.ibm.xmlns.prod.streams.spl.source.code.CompositeHeadType#getOutputs
 *       <em>Outputs</em>}
 *   <li>{@link com.ibm.xmlns.prod.streams.spl.source.code.CompositeHeadType#getName <em>Name</em>}
 * </ul>
 *
 * @see com.ibm.xmlns.prod.streams.spl.source.code.CodePackage#getCompositeHeadType()
 * @model extendedMetaData="name='compositeHeadType' kind='elementOnly'"
 * @generated
 */
public interface CompositeHeadType extends SourceLocationType {
  /**
   ...
   * @see com.ibm.xmlns.prod.streams.spl.source.code.CodePackage#getCompositeHeadType_SplDoc()
   ...
   * @see #setModifiers(CompositeModifiersType)
   * @see com.ibm.xmlns.prod.streams.spl.source.code.CodePackage#getCompositeHeadType_Modifiers()
   * @model containment="true" extendedMetaData="kind='element' name='modifiers'
   *     namespace='##targetNamespace'"
   * @generated
   */
  CompositeModifiersType getModifiers();
   ...
   * @generated
   */
  void setModifiers(CompositeModifiersType value);
   ...
   * @see #setInputs(CompositeInputsType)
   * @see com.ibm.xmlns.prod.streams.spl.source.code.CodePackage#getCompositeHeadType_Inputs()
   * @model containment="true" extendedMetaData="kind='element' name='inputs'
   *     namespace='##targetNamespace'"
   * @generated
   */
  CompositeInputsType getInputs();
   ...
   * @generated
   */
  void setInputs(CompositeInputsType value);
   ...
   * @see #setOutputs(CompositeOutputsType)
   * @see com.ibm.xmlns.prod.streams.spl.source.code.CodePackage#getCompositeHeadType_Outputs()
   * @model containment="true" extendedMetaData="kind='element' name='outputs'
   *     namespace='##targetNamespace'"
   * @generated
   */
  CompositeOutputsType getOutputs();
   ...
   * @generated
   */
  void setOutputs(CompositeOutputsType value);
   ...
   * @see #setName(String)
   * @see com.ibm.xmlns.prod.streams.spl.source.code.CodePackage#getCompositeHeadType_Name()
  ...
  /**
   * Sets the value of the '{@link
   * com.ibm.xmlns.prod.streams.spl.source.code.CompositeHeadType#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   *
