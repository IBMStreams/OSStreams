...
public final class TimedWindowedTuple<T> extends WindowedTuple<T> {

  /** */
  private static final long serialVersionUID = 81294079093402924L;

  private final long arrivalTime = System.currentTimeMillis();

  TimedWindowedTuple(T tuple) {
    super(tuple);
  }
