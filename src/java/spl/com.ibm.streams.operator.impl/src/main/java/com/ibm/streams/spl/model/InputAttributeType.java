...
/**
 * Java class for inputAttributeType complex type.
 *
...
@XmlType(
    name = "inputAttributeType",
    propOrder = {"name", "cppType", "splType"})
@XmlSeeAlso({OutputAttributeType.class})
public class InputAttributeType {
