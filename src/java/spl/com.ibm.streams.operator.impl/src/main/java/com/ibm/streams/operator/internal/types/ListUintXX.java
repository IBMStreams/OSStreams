 ...
 */
abstract class ListUintXX extends ListSpl {

  ListUintXX(TypeEncoding encoding, @SuppressWarnings("rawtypes") ImplementationType elementType) {
    super(MetaType.LIST, encoding, elementType);
  }
