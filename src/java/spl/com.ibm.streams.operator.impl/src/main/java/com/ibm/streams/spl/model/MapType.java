 ...
 *       &lt;sequence>
 *         &lt;element name="value" type="{http://www.ibm.com/xmlns/prod/streams/spl/operator/instance}mapElementType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class MapType {
  ...
  protected List<MapElementType> value;
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link MapElementType }
   */
  public List<MapElementType> getValue() {
    if (value == null) {
      value = new ArrayList<MapElementType>();
    }
    return this.value;
  }
