 ...
 * @param <T> Tuple type.
 */
final class SlidingTimeEvictDeltaTrigger<T, P> extends SlidingTimeEvict<T, P> {

  private static final long serialVersionUID = 7453987384442011037L;
  private final DeltaPolicy<T, WindowedTuple<T>> trigger;

  @SuppressWarnings("unchecked")
  SlidingTimeEvictDeltaTrigger(WindowHandler<T> windowHandler, P partition) {
