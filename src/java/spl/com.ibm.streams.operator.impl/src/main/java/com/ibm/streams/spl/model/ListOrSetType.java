 ...
 *       &lt;sequence>
 *         &lt;element name="value" type="{http://www.ibm.com/xmlns/prod/streams/spl/operator/instance}literalType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class ListOrSetType {
  ...
  protected List<LiteralType> value;
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link LiteralType }
   */
  public List<LiteralType> getValue() {
    if (value == null) {
      value = new ArrayList<LiteralType>();
    }
    return this.value;
  }
