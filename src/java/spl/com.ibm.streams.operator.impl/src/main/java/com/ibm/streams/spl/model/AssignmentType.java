 ...
 *         &lt;element name="outputFunction" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(
    name = "assignmentType",
    propOrder = {"sourceLocation", "outputFunction", "values"})
public class AssignmentType {
  ...
  /**
   * Gets the value of the outputFunction property.
   *
  ...
  /**
   * Sets the value of the outputFunction property.
   *
   * @param value allowed object is {@link String }
   */
  public void setOutputFunction(String value) {
