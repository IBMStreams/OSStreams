...
// package com.ibm.distillery.other.build.util;
...
/*
 * java -cp /view/laurieaw_install_CONCORD_dyn/repos/Distillery/Other/build/com.ibm.distillery.other.build/lib/distillery.build.jar  com.ibm.distillery.other.build.util.GenerateInstallMessageKeyConstants -c StreamsInstallMessagesKey StreamsInstallMessages.xlf
 *
 */
 ...
 */
public class GenerateInstallMessageKeyConstants {
  public static final String USAGE =
      "\nUsage: GenerateInstallMessageKeyConstants [OPTIONS] [XLIFF-FILE]\n\n"
  ...
  public static void main(String[] args) {
    ...
    try {
      GenerateInstallMessageKeyConstants gen =
          new GenerateInstallMessageKeyConstants(
  ...
  public GenerateInstallMessageKeyConstants(
  ...
  public void generate() throws Exception {
    ...
    for (int g = 0; g < groups.getLength(); g++) {
      ...
      for (int i = 0; i < nodes.getLength(); i++) {
        ...
        outStream.write(
            " public static final String " + constantName + " = \"" + messageKey + "\";" + NEWLINE);
      }
  ...
  private void writeHeader(BufferedWriter outStream, String className, String bundleName)
    ...
    final String header =
        "package "
            ...
            + NEWLINE;
    // NEWLINE +
    //  "   public enum Key implements MessageKey {" + NEWLINE
