...
public class ParallelRegionSplitter {
  private final BigInteger iPortIndex = null;;
  private final String kind = null;
  private final String portSelector = null; // May be null
  private final List<String> attributes = null;

  private ParallelRegionSplitter() {}
