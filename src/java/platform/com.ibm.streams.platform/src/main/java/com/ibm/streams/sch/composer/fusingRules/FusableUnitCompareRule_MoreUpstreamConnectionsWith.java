...
public class FusableUnitCompareRule_MoreUpstreamConnectionsWith extends FusableUnitCompareRule {

  @Override
  public Integer compare(FusableUnit o1, FusableUnit o2) {
    FusableUnitComparator.addJrnlMsg(" <musc> ");
    ...
    int numOfConnDelta =
        _composedContainer.numOfUpstreamConnectionsWith(o2)
            - _composedContainer.numOfUpstreamConnectionsWith(o1);
    if (numOfConnDelta != 0) {
      FusableUnitComparator.addJrnlMsg(
          "FU["
              + _composedContainer.numOfUpstreamConnectionsWith(o1)
  ...
  public FusableUnitCompareRule_MoreUpstreamConnectionsWith(ComposedContainer cont) {
    _composedContainer = cont;
  }

  public String toString() {
    return "<FCR: Most upStr connections with>";
  }
}
