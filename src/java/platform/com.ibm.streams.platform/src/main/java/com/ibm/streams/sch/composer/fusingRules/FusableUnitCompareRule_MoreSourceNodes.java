...
public class FusableUnitCompareRule_MoreSourceNodes extends FusableUnitCompareRule {
  ...
  public Integer compare(FusableUnit o1, FusableUnit o2) {
    ...
    int numOfSourceNodes = o2.numOfSourceNodes() - o1.numOfSourceNodes();
    if (numOfSourceNodes != 0) {
      FusableUnitComparator.addJrnlMsg(
          "FU[" + o1.numOfSourceNodes() + "]=||FU[" + o2.numOfSourceNodes() + "]= ;");
    }
    return (numOfSourceNodes);
  }

  public FusableUnitCompareRule_MoreSourceNodes(ComposedContainer cont) {
    _composedContainer = cont;
  }

  public String toString() {
    return "<FCR: Most Source nodes>";
  }
}
