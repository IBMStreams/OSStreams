...
public class SplitterOperatorSerializer extends PrimitiveOperatorBaseSerializer
    implements JsonSerializer<SplitterOperator> {

  @Override
  public JsonElement serialize(SplitterOperator oper, Type type, JsonSerializationContext context) {
