...
public class ComposedContainerCompareRule_FewerDownstreamConnections
    implements ComposedContainerCompareRule {

  @Override
  public int compare(ComposedContainer o1, ComposedContainer o2) {
    return (o1.numOfDownstreamInterContainerConnections()
        - o2.numOfDownstreamInterContainerConnections());
  }

  public String toString() {
    return "<CCCR: Fewer DnStream Connections>";
  }
}
