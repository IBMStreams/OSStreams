...
public class ComposedContainerCompareRule_MoreDownstreamConnections
    implements ComposedContainerCompareRule {

  @Override
  public int compare(ComposedContainer o1, ComposedContainer o2) {
    return (o2.numOfDownstreamInterContainerConnections()
        - o1.numOfDownstreamInterContainerConnections());
  }

  public String toString() {
    return "<CCCR: More DnStream Connections>";
  }
}
