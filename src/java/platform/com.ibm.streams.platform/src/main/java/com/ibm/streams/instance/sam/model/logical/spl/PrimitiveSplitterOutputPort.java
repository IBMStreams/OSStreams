...
public class PrimitiveSplitterOutputPort extends PrimitiveOutputPort {

  public PrimitiveSplitterOutputPort(
    ...
    super(index, logicalStreamName, owningPrimitiveOp, model);
  }

  @Override
  public BigInteger getTupleTypeIndex(SPLLogicalModel model) throws SAMInternalErrorException {
    return getOwningOperator().asSplitterOperator().getTupleTypeIndex(model);
  }
}
