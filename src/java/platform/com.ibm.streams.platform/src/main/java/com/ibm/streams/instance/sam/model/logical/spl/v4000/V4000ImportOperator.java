...
public class V4000ImportOperator extends ImportOperator {
  public V4000ImportOperator(
    ...
    if (primitiveOperInstanceType.getOutputPorts() != null) {
      for (PrimitiveOperInstancePortType primitiveOperInstancePortType :
        ...
        PrimitiveImportOutputPort mpop =
            new PrimitiveImportOutputPort(
                primitiveOperInstancePortType.getIndex(), /*iStream,*/ this, model);
