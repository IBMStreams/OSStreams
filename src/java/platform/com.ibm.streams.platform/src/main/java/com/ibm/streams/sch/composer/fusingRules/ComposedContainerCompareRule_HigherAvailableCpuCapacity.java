...
public class ComposedContainerCompareRule_HigherAvailableCpuCapacity
    implements ComposedContainerCompareRule {

  @Override
  public int compare(ComposedContainer o1, ComposedContainer o2) {
    return (int) (o2.getAvailableCpuCapacity() - o1.getAvailableCpuCapacity());
  }

  public String toString() {
    return "<CCCR: Higher Available CPU Capacity>";
  }
}
