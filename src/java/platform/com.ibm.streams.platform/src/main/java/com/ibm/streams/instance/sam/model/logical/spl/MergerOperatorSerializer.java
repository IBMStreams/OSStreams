...
public class MergerOperatorSerializer extends PrimitiveOperatorBaseSerializer
    implements JsonSerializer<MergerOperator> {

  @Override
  public JsonElement serialize(MergerOperator oper, Type type, JsonSerializationContext context) {
