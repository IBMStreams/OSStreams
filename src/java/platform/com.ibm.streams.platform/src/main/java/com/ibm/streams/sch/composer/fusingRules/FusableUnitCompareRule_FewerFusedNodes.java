...
public class FusableUnitCompareRule_FewerFusedNodes extends FusableUnitCompareRule {
  ...
  public Integer compare(FusableUnit o1, FusableUnit o2) {
    ...
    int numOfConnDelta = o1.getNumOfFusedNodes() - o2.getNumOfFusedNodes();
    if (numOfConnDelta != 0) {
      FusableUnitComparator.addJrnlMsg(
  ...
  public FusableUnitCompareRule_FewerFusedNodes(ComposedContainer cont) {
    _composedContainer = cont;
  }

  public String toString() {
    return "<FCR: Fewer fused nodes>";
  }
}
