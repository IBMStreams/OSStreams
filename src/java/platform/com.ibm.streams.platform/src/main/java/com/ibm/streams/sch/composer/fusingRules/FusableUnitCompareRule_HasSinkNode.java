...
public class FusableUnitCompareRule_HasSinkNode extends FusableUnitCompareRule {

  @Override
  public Integer compare(FusableUnit o1, FusableUnit o2) {
    FusableUnitComparator.addJrnlMsg(" <sk> ");
    ...
    if (o1.includesSinkNode() == o2.includesSinkNode()) return 0;
    return (o1.includesSinkNode() ? -1 : 1);
  }

  public FusableUnitCompareRule_HasSinkNode(ComposedContainer cont) {
    _composedContainer = cont;
  }

  public String toString() {
    return "<FCR: Includes SinkNode>";
  }
}
