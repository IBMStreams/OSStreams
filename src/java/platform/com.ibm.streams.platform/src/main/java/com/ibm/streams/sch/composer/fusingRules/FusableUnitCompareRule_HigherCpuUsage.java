...
public class FusableUnitCompareRule_HigherCpuUsage extends FusableUnitCompareRule {

  @Override
  public Integer compare(FusableUnit o1, FusableUnit o2) {
    return (int) (o2.getCpuUsage() - o1.getCpuUsage());
  }

  public FusableUnitCompareRule_HigherCpuUsage(ComposedContainer cont) {
    _composedContainer = cont;
  }

  public String toString() {
    return "<FCR: Higher CPU Usage>";
  }
}
