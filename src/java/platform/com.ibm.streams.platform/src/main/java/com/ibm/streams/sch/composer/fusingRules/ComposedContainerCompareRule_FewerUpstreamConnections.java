...
public class ComposedContainerCompareRule_FewerUpstreamConnections
    implements ComposedContainerCompareRule {

  @Override
  public int compare(ComposedContainer o1, ComposedContainer o2) {
    return (o2.numOfUpstreamInterContainerConnections()
        - o1.numOfUpstreamInterContainerConnections());
  }

  public String toString() {
    return "<CCCR: More UpStream Connections>";
  }
}
