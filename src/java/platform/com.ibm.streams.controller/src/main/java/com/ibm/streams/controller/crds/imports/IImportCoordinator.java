...
public interface IImportCoordinator extends IEventConsumerDelegate<Import> {

  void setImportFilter(Import imp, String filter);

  void setImportImportedStreams(Import imp, ImportedStreamsType streams);
