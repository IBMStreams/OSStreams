...
public class ConsistentRegionOperatorStore
    extends ConcurrentHashMap<Object, ConsistentRegionOperator> {
  public void put(ConsistentRegionOperator cro) {
    put(cro.getMetadata().getName(), cro);
  }

  public long countCrosWithJob(Job job) {
