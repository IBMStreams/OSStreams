...
public interface IParallelRegionCoordinator extends IEventConsumerDelegate<ParallelRegion> {

  void setParallelRegionWidth(ParallelRegion pr, BigInteger width);
